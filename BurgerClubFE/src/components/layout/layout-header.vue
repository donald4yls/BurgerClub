<template>
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}" @click.stop="mobileShow=false">
        <div class="site-logo">
            <router-link to="/">
                <img src="@/assets/burgerClub-logo.svg" alt="">
                <p class="site-name">Burger Club</p>
            </router-link>
        </div>
        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <div class="menu-item"><router-link to="/friend">My Burger Active</router-link></div>
            <div class="menu-item"><router-link to="/about">AboutUS</router-link></div>
        </div>
    </div>
</template>
